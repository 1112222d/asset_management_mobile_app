...
import com.example.assets.AdminActivity.CreateNewAssignmentActivity;
...
public class MyAssignmentActivity extends AppCompatActivity {
    ...
    CustomListViewAssignmentUserAdapter customListViewAssignmentAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customListViewAssignmentAdapter = new CustomListViewAssignmentUserAdapter(getApplicationContext(),listFilterAssignment);
        loadAssignment();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(MyAssignmentActivity.this, ViewAssignmentActivity.class);
    ...
    {
        MainActivity.service.getAllAssignmentUser().enqueue(new Callback<List<Assignment>>() {
            @RequiresApi(api = Build.VERSION_CODES.N)
            @Override
