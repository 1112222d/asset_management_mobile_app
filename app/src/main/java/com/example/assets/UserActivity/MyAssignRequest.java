...
import com.example.assets.Adapter.CustomListViewAssignmentUserAdapter;
...
public class MyAssignRequest extends AppCompatActivity {
    ListView listView;
    ...
    EditText ed_search;
    ImageView btnCreateAssignRequest;
    List<AssignRequestRespone> listDataAssignment,listShowAssignment,listFilterAssignment;
    int item_select=0;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_my_assign_request);
        listView=findViewById(R.id.assignListView);
        btnCreateAssignRequest = findViewById(R.id.btn_createassignrequest);
        ...
        loadAssignment();
        btnCreateAssignRequest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MyAssignRequest.this,CreateNewAssignActivity.class);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(MyAssignRequest.this, EditAssignActivity.class);
