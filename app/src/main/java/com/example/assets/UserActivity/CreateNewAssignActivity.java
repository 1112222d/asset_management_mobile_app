...
public class CreateNewAssignActivity extends AppCompatActivity {
    ...
    Dialog dialog;
    public static CustomListViewCategoryAdapter customListViewCategoryAdapter,customListViewCategorySelectAdapter;
    MaterialDatePicker.Builder builder = MaterialDatePicker.Builder.datePicker();
    MaterialDatePicker materialDatePicker;
    long startDate=0, dueDate=0,quantityAvailableOfCategory=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customListViewCategorySelectAdapter=new CustomListViewCategoryAdapter(CreateNewAssignActivity.this,listCategoriesSelect);
            ...
            public void onClick(View view) {
                ...
                if(cateSelect!=null&&number>0)
                {
                    ...
                    }else
                    {
                        ...
                        listCategoriesSelect.add(cateSelect);
