...
//                Intent intent = new Intent(RequestActivity.this,EditAssignmentActivity.class);
//                intent.putExtra("assignment", (Serializable) customListViewRequestAdapter.getItem(position));
//                startActivity(intent);
    ...
    public void sort()
    {
        Collections.sort(listFilterRequest,(o1, o2)->
