...
public class CustomListViewShowAssetSelectedAdapter extends BaseAdapter {

    Context context;
    List<Assignment.AssignmentDetail> assets;


    public CustomListViewShowAssetSelectedAdapter(Context context, List<Assignment.AssignmentDetail> assets) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Assignment.AssignmentDetail asset = (Assignment.AssignmentDetail) getItem(position);
        ViewHolder holder;
